define("pagelet/async/v4/gallery/gallery.js", function(e, t, n) {
    ...
    var i = function(e, t, n, o) {
            ...
            detectFeatures: function() {
                ...
                !o.pointerEvent) {
                    ...
                    if (/iP(hone|od)/.test(navigator.platform)) {
                        ...
                        r && r.length > 0 && (r = parseInt(r[1], 10),
                        r >= 1 && 8 > r && (o.isOldIOSPhone = !0))
                    }
                    var l = a.match(/Android\s([0-9\.]*)/)
                      , s = l ? l[1] : 0;
                    s = parseFloat(s),
                    s >= 1 && (4.4 > s && (o.isOldAndroid = !0),
                    o.androidVersion = s),
        ...
        var u, c, d, p, m, f, h, v, w, g, y, x, b, _, C, I, T, E, D, S, M, F, k, O, A, R, L, P, Z, z, N, U, K, B, H, W, Y, G, q, V, X, $, j, J, Q, et, tt, nt, ot, it, at, rt, lt, st, ut, ct, dt = function() {
            ...
            (!Ct || i && i !== a.currItem) && (o /= i ? i.fitRatio : a.currItem.fitRatio),
            e[F] = x + t + "px, " + n + "px" + b + " scale(" + o + ")"
        }, Ot = function(e) {
            ot && (e && (g > a.currItem.fitRatio ? Ct || (mo(a.currItem, !1, !0),
            Ct = !0) : Ct && (mo(a.currItem),
            Ct = !1)),
            kt(ot, ft.x, ft.y, g))
        }, At = function(e) {
            ...
            Nt && (i.unbind(document, "mousemove", Ut),
            ...
            init: function() {
                if (!u && !c) {
                    ...
                    a.currItem = Qn(p),
                    (N.isOldIOSPhone || N.isOldAndroid) && (xt = !1),
                    e.setAttribute("aria-hidden", "false"),
                    s.modal && (xt ? e.style.position = "fixed" : (e.style.position = "absolute",
                    e.style.top = i.getScrollY() + "px")),
                    void 0 === z && (St("initialLayout"),
                    z = P = i.getScrollY());
                    var d = "pswp--open ";
                    for (s.mainClass && (d += s.mainClass + " "),
                    ...
                    yt = null ,
                    n = 0; l > n; n++)
                        Rt((n + f) * gt.x, I[n].el.style);
                    Z || i.bind(a.scrollWrap, v, a),
                    Dt("initialZoomInEnd", function() {
                        a.setContent(I[0], p - 1),
                        a.setContent(I[2], p + 1),
            ...
            panTo: function(e, t, n) {
                n || (e > nt.min.x ? e = nt.min.x : e < nt.max.x && (e = nt.max.x),
                t > nt.min.y ? t = nt.min.y : t < nt.max.y && (t = nt.max.y)),
                ft.x = e,
                ft.y = t,
                Ot()
            },
                ...
                if (0 !== yt) {
                    ...
                    if (!(e && 2 > n)) {
                        ...
                        for (var o = 0; n > o; o++)
                            ...
                            I[l - 1] = t,
                            f++,
                            Rt((f + 2) * gt.x, t.el.style),
                            a.setContent(t, p - n + o + 1 + 1)) : (t = I.pop(),
                            I.unshift(t),
                            f--,
                            Rt(f * gt.x, t.el.style),
                            a.setContent(t, p + n - o - 1 - 1));
                        if (ot && 1 === Math.abs(yt)) {
                            var i = Qn(T);
                            i.initialZoomLevel !== g && (so(i, ht),
                            mo(i),
                            At(i))
                        }
                        yt = 0,
            ...
            updateSize: function(t) {
                if (!xt && s.modal) {
                    ...
                    z = n),
                    !t && _t.x === window.innerWidth && _t.y === window.innerHeight)
                        return;
                    _t.x = window.innerWidth,
                    _t.y = window.innerHeight,
                    e.style.height = _t.y + "px"
                }
                if (ht.x = a.scrollWrap.clientWidth,
                ht.y = a.scrollWrap.clientHeight,
                $t(),
                gt.x = ht.x + Math.round(ht.x * s.spacing),
                gt.y = ht.y,
                Lt(gt.x * vt),
                St("beforeResize"),
                void 0 !== f) {
                    for (var o, r, u, c = 0; l > c; c++)
                        o = I[c],
                        Rt((c + f) * gt.x, o.el.style),
                        u = p + c - 1,
                        s.loop && eo() > 2 && (u = Tt(u)),
                        r = Qn(u),
                        r && (C || r.needsUpdate || !r.bounds) ? (a.cleanSlide(r),
                        a.setContent(o, u),
                        1 === c && (a.currItem = r,
                        a.updateCurrZoomItem(!0)),
                        r.needsUpdate = !1) : -1 === o.index && u >= 0 && a.setContent(o, u),
                        r && r.container && (so(r, ht),
                        mo(r),
                        At(r));
                    C = !1
                }
            ...
            zoomTo: function(e, t, n, o, a) {
                t && (y = g,
                xn.x = Math.abs(t.x) - ft.x,
                xn.y = Math.abs(t.y) - ft.y,
                Zt(mt, ft));
                var r = Ht(e, !1)
                  , l = {};
                Gt("x", r, l, e),
            ...
            return Mn.prevent = !Sn(e.target, s.isClickableElement),
            St("preventDragEvent", e, t, Mn),
            Mn.prevent
        }, kn = function(e, t) {
            return t.x = e.pageX,
            t.y = e.pageY,
            ...
            pn.forEach(function(e) {
                0 === ct ? Zn[0] = e : 1 === ct && (Zn[1] = e),
                ct++
            })) : e.type.indexOf("touch") > -1 ? e.touches && e.touches.length > 0 && (Zn[0] = kn(e.touches[0], Ln),
            e.touches.length > 1 && (Zn[1] = kn(e.touches[1], Pn))) : (Ln.x = e.pageX,
            Ln.y = e.pageY,
            Ln.id = "",
            Zn[0] = Ln),
            Zn
            ...
            return n = u > nt.min[e] || u < nt.max[e] ? s.panEndFriction : 1,
            u = ft[e] + t[e] * n,
            !s.allowPanToNext && g !== a.currItem.initialZoomLevel || (ot ? "h" !== at || "x" !== e || V || (c ? (u > nt.min[e] && (n = s.panEndFriction,
            l = nt.min[e] - u,
            o = nt.min[e] - mt[e]),
            (0 >= o || 0 > p) && eo() > 1 ? (r = d,
            ...
            o = mt[e] - nt.max[e]),
            (0 >= o || p > 0) && eo() > 1 ? (r = d,
            p > 0 && d < mn.x && (r = mn.x)) : nt.min.x !== nt.max.x && (i = u))) : r = d,
            "x" !== e) ? void (it || j || g > a.currItem.fitRatio && (ft[e] += t[e] * n)) : (void 0 !== r && (Lt(r, !0),
            j = r === mn.x ? !1 : !0),
            nt.min.x !== nt.max.x && (void 0 !== i ? ft.x = i : j || (ft.x += t.x * n)),
            void 0 !== r)
        }, Un = function(e) {
            if (!("mousedown" === e.type && e.button > 0)) {
                ...
                if (!Y || "mousedown" !== e.type) {
                    ...
                    Zt(sn, n[1]),
                    On(ln, sn, bn),
                    xn.x = Math.abs(bn.x) - ft.x,
                    xn.y = Math.abs(bn.y) - ft.y,
                    et = tt = In(ln, sn))
                }
            }
        }, Kn = function(e) {
                ...
                if (0 !== e)
                    ...
                    Q && e > 1) {
                        ...
                        var o = 1
                          ...
                          , r = Yt();
                        if (i > n)
                            if (s.pinchToClose && !ut && y <= a.currItem.initialZoomLevel) {
                                var l = i - n
                                  , u = 1 - l / (i / 1.2);
                                Ft(u),
                                St("onPinchClose", u),
                        ...
                        if (!at)
                            return;
                        if (rt && (rt = !1,
                        Math.abs(un.x) >= rn && (un.x -= J[0].x - dn.x),
                        Math.abs(un.y) >= rn && (un.y -= J[0].y - dn.y)),
                        cn.x = ln.x,
                        cn.y = ln.y,
                        0 === un.x && 0 === un.y)
                            return;
            ...
            St("pointerUp"),
            Fn(e, !1) && e.preventDefault();
            var t;
            if (k) {
                var n = i.arraySearch(pn, e.pointerId, "id");
                if (n > -1)
                    if (t = pn.splice(n, 1)[0],
                ...
                W) {
                    ...
                    if (d < s.verticalDragRange)
                        ...
                        nn("verticalDrag", 0, 1, 300, i.easing.cubic.out, function(e) {
                            ft.y = (a.currItem.initialPosition.y - p) * e + p,
                            Ft((1 - m) * e + m),
                            Ot()
                        }),
                        St("onVerticalDrag", 1)
                    ...
                    if (!it)
                        return "swipe" !== r ? void Vn() : void (!j && g > a.currItem.fitRatio && Yn(B))
                }
        }, Wn = function() {
            var e, t, n = {
                lastFlickOffset: {},
                ...
                calculateSwipeSpeed: function(o) {
                    fn.length > 1 ? (e = Mt() - K + 50,
                    t = fn[fn.length - 2][o]) : (e = Mt() - U,
                    t = dn[o]),
                    n.lastFlickOffset[o] = cn[o] - t,
                    n.lastFlickDist[o] = Math.abs(n.lastFlickOffset[o]),
                    n.lastFlickSpeed[o] = n.lastFlickDist[o] > 20 ? n.lastFlickOffset[o] / e : 0,
                ...
                panAnimLoop: function() {
                    ...
                    n.speedDecelerationRatioAbs.x < .05 && n.speedDecelerationRatioAbs.y < .05) ? (ft.x = Math.round(ft.x),
            ...
            nn("mainScroll", yn.x, d, c, i.easing.cubic.out, Lt, function() {
                tn(),
                it = !1,
                vn = -1,
        ...
        It("Gestures", {
            publicMethods: {
                initGestures: function() {
                    ...
                    k = N.pointerEvent,
                    k && N.touch && (N.touch = !1),
                    k ? navigator.pointerEnabled ? e("pointer", "down", "move", "up", "cancel") : e("MSPointer", "Down", "Move", "Up", "Cancel") : N.touch ? (e("touch", "start", "move", "end", "cancel"),
                    O = !0) : e("mouse", "down", "move", "up"),
                    h = D + " " + S + " " + M,
                    v = E,
                    k && !O && (O = navigator.maxTouchPoints > 1 || navigator.msMaxTouchPoints > 1),
        ...
        var Xn, $n, jn, Jn, Qn, eo, to, no = function(t, n, o, r) {
            ...
            var u = o ? s.hideAnimationDuration : s.showAnimationDuration
              , c = function() {
                ...
                a.bg.removeAttribute("style")) : (Ft(1),
            ...
            var f = function() {
                ...
                r && (o ? i[(n ? "remove" : "add") + "Class"](e, "pswp--animate_opacity") : setTimeout(function() {
                    ...
                    o) {
                        var a = l.w / t.w
                          ...
                          , m = function(t) {
                            1 === t ? (g = a,
                            ft.x = l.x,
                            ft.y = l.y - z) : (g = (a - d) * t + d,
                            ft.x = (l.x - s.x) * t + s.x,
                            ft.y = (l.y - z - s.y) * t + s.y),
                            Ot(),
                            r ? e.style.opacity = 1 - t : Ft(p - t * p)
                        };
                        n ? nn("initialZoom", 0, 1, u, i.easing.cubic.out, m, c) : (m(1),
            ...
            o.max.y = n > oo.y ? Math.round(oo.y - n) + e.vGap.top : o.center.y,
            ...
            if (io.length) {
                for (var e, t = 0; t < io.length; t++)
                    e = io[t],
                    e.holder.index === e.index && uo(e.index, e.item, e.baseDiv, e.img, !1, e.clearPlaceholder);
                io = []
            }
        };
        It("Controller", {
            publicMethods: {
                lazyLoadItem: function(e) {
                    e = Tt(e);
                    var t = Qn(e);
                    !t || t.loaded || t.loading || (St("gettingData", e, t),
                    t.src && co(t))
                },
                initController: function() {
                    ...
                    Dt("mainScrollAnimComplete", fo),
                    Dt("initialZoomInEnd", fo),
                    Dt("destroy", function() {
                ...
                setContent: function(e, t) {
                    ...
                    !r.src || r.loadError || r.loaded)
                        r.src && !r.loadError && (o = i.createEl("pswp__img", "img"),
                        o.style.opacity = 1,
                        o.src = r.src,
                        mo(r, o),
                        uo(t, r, l, o, !0));
                        ...
                        r.loading || co(r),
                        a.allowProgressiveImg() && (!jn && N.transform ? io.push({
                            item: r,
                            baseDiv: l,
                            img: r.img,
                            index: t,
        ...
        It("Tap", {
            publicMethods: {
                initTap: function() {
                    Dt("firstTouchStart", a.onTapStart),
                    Dt("touchRelease", a.onTapRelease),
                    Dt("destroy", function() {
                        vo = {},
                        ho = null
                    })
                ...
                onTapStart: function(e) {
                    e.length > 1 && (clearTimeout(ho),
                    ho = null )
                },
                onTapRelease: function(e, t) {
                    if (t && !X && !q && !Jt) {
                        var n = t;
                        if (ho && (clearTimeout(ho),
                        ho = null ,
                        Cn(n, vo)))
            ...
            publicMethods: {
                ...
                setupDesktopZoom: function(t) {
                    ...
                    var o, r = function() {
                        ...
                        a.mouseZoomedIn = !1),
                        1 > g ? i.addClass(e, "pswp--zoom-allowed") : i.removeClass(e, "pswp--zoom-allowed"),
                        l()
                    }, l = function() {
                ...
                handleMouseWheel: function(e) {
                    if (g <= a.currItem.fitRatio)
                        return s.modal && (!s.closeOnScroll || Jt || G ? e.preventDefault() : F && Math.abs(e.deltaY) > 2 && (d = !0,
                        a.close())),
                        !0;
                    if (e.stopPropagation(),
                    go.x = 0,
                    "deltaX"in e)
                        1 === e.deltaMode ? (go.x = 18 * e.deltaX,
                        go.y = 18 * e.deltaY) : (go.x = e.deltaX,
                        go.y = e.deltaY);
                    else if ("wheelDelta"in e)
                        e.wheelDeltaX && (go.x = -.16 * e.wheelDeltaX),
                        go.y = e.wheelDeltaY ? -.16 * e.wheelDeltaY : -.16 * e.wheelDelta;
                    else {
                        if (!("detail"in e))
                            return;
                        go.y = e.detail
        ...
        var yo, xo, bo, _o, Co, Io, To, Eo, Do, So, Mo, Fo, ko = {
            history: !0,
            galleryUID: 1
        }, Oo = function() {
            ...
            Fo ? "#" + n !== window.location.hash && history[Eo ? "replaceState" : "pushState"]("", document.title, o) : Eo ? Mo.replace(o) : Mo.hash = n,
            Eo = !0,
            ...
            publicMethods: {
                initHistory: function() {
                    ...
                    s.history) {
                        ...
                        To.indexOf("gid=") > -1 && (To = To.split("&gid=")[0],
                        To = To.split("?gid=")[0]),
                        Dt("afterChange", a.updateURL),
                        Dt("unbindEvents", function() {
                            i.unbind(window, "hashchange", a.onHashChange)
                        });
                        var e = function() {
                            Io = !0,
                            Do || (So ? history.back() : To ? Mo.hash = To : Fo ? history.pushState("", document.title, Mo.pathname + Mo.search) : Mo.hash = ""),
                            Ao()
                        };
                        Dt("unbindEvents", function() {
                            d && e()
                        ...
                        t > -1 && (To = To.substring(0, t),
                        "&" === To.slice(-1) && (To = To.slice(0, -1))),
                        setTimeout(function() {
                ...
                onHashChange: function() {
                    return Oo() === To ? (Do = !0,
                    void a.close()) : void (_o || (Co = !0,
                    a.goTo(Ro().pid),
                    Co = !1))
                },
                updateURL: function() {
                    Ao(),
                    Co || (Eo ? yo = setTimeout(Lo, 800) : Lo())
                }
            }
        }),
        i.extend(a, on)
      ...
      , a = function(e, t) {
        var n, o, i, a, r, l, s, u, c, d, p, m, f, h, v, w, g, y, x, b = this, _ = !1, C = !0, I = !0, T = {
            ...
            for (var n, o, i = e.target || e.srcElement, a = i.className, r = 0; r < W.length; r++)
                n = W[r],
            ...
            e !== h && (S(o, "ui--one-slide", e),
            h = e)
        }, F = function() {
            S(s, "share-modal--hidden", I)
        }, k = function() {
            return I = !I,
            I ? (t.removeClass(s, "pswp__share-modal--fade-in"),
            setTimeout(function() {
                I && F()
            }, 300)) : (F(),
            setTimeout(function() {
            ...
            n.href ? n.hasAttribute("download") ? !0 : (window.open(n.href, "pswp_share", "scrollbars=yes,resizable=yes,toolbar=no,location=yes,width=550,height=420,top=100,left=" + (window.screen ? Math.round(screen.width / 2 - 275) : 100)),
            I || k(),
            !1) : !1
        }, A = function() {
            for (var e, t, n, o, i, a = "", r = 0; r < v.shareButtons.length; r++)
                e = v.shareButtons[r],
            ...
            v.fullscreenEl && (n || (n = b.getFullscreenAPI()),
                ...
                if (o)
                    for (var a = o.length, r = 0; a > r; r++) {
                        ...
                        for (var l = 0; l < W.length; l++)
                            i = W[l],
                            n.indexOf("pswp__" + i.name) > -1 && (v[i.option] ? (t.removeClass(e, "pswp__element--disabled"),
        ...
        b.update = function() {
            ...
            v.captionEl && (v.addCaptionHTMLFn(e.currItem, i),
